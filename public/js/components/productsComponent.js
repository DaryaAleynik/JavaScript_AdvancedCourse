Vue.component('products-comp', {
    ...
    methods: {
        filter(userSearch) {
            ...
            this.filtered = this.products.filter(el => regExp.test(el.nameProduct));
        }
    },
    template: `
        <section class="products">
            <div class="content-container">
                <p class="products-title">Featured Items</p>
                <p class="products-text">Shop for items based on what we featured in this week</p>
                <ul class="products-list">
                    <product-comp v-for="product of filtered"
        ...
        <li>
            <article class="product-item">
                ...
                <div class="product-item-text-wrp">
                    <p class="product-item-title">{{product.nameProduct}}</p>
                    <p class="product-item-text">{{product.description}}</p>
                    <p class="product-item-price">{{product.price}} $</p>
                </div>
                <button class="product-item-btn" @click="$root.$refs.cart.addProduct(product)">
